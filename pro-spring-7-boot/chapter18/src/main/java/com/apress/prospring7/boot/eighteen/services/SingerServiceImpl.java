...
SOFTWARE.
*/
package com.apress.prospring7.boot.eighteen.services;

import com.apress.prospring7.boot.eighteen.entities.Singer;
import com.apress.prospring7.boot.eighteen.ex.NotFoundException;
import com.apress.prospring7.boot.eighteen.repos.SingerRepo;
...
public class SingerServiceImpl implements SingerService {
    ...
    public List<Singer> findByFirstNameAndLastName(String firstName, String lastName) {
        return (List<Singer>) singerRepo.findByFirstNameAndLastName(firstName,lastName);
    }
