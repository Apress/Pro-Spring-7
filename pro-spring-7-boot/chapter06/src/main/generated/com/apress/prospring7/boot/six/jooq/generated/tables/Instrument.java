...
import com.apress.prospring7.boot.six.jooq.generated.tables.SingerInstrument.SingerInstrumentPath;
import com.apress.prospring7.boot.six.jooq.generated.tables.records.InstrumentRecord;
...
public class Instrument extends TableImpl<InstrumentRecord> {
    ...
    public SingerInstrumentPath singerInstrument() {
        if (_singerInstrument == null)
            _singerInstrument = new SingerInstrumentPath(this, null, Keys.FK_SINGER_INSTRUMENT_2.getInverseKey());
     ...
     * <code>musicdb.SINGER</code> table
     */
    public SingerPath singer() {
        return singerInstrument().singer();
    }
