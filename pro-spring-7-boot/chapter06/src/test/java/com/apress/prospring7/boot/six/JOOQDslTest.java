...
SOFTWARE.
*/
package com.apress.prospring7.boot.six;

import com.apress.prospring7.boot.six.jooq.generated.tables.records.SingerRecord;
import com.apress.prospring7.boot.six.jooq.records.AlbumRecord;
import com.apress.prospring7.boot.six.jooq.records.SingerWithAlbums;
import com.apress.prospring7.boot.six.jooq.records.SingerWithInstruments;
...
import static com.apress.prospring7.boot.six.jooq.generated.tables.Album.ALBUM;
import static com.apress.prospring7.boot.six.jooq.generated.tables.Singer.SINGER;
import static com.apress.prospring7.boot.six.jooq.generated.tables.SingerInstrument.SINGER_INSTRUMENT;
...
public class JOOQDslTest {
    ...
    @Test
    @SqlGroup({
            @Sql(scripts = {"classpath:jooq/add-nina.sql"},
                    executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD),
            @Sql(scripts = {"classpath:jooq/remove-nina.sql"},
    ...
    @Test
    @Sql(scripts = {"classpath:jooq/add-chuck.sql"},
            executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
