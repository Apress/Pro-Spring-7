...
import com.apress.prospring7.boot.five.repo.SingerRepo;
...
public class Chapter5ApplicationTcTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(Chapter5ApplicationTcTest.class);
