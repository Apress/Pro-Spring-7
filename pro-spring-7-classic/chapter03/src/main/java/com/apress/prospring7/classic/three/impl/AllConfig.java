...
SOFTWARE.
*/
package com.apress.prospring7.classic.three.impl;

import com.apress.prospring7.classic.three.impl.provider.ConfigurableMessageProvider;
...
public class AllConfig {
    ...
    MessageRenderer messageRenderer(){
        MessageRenderer messageRenderer = new LogMessageRenderer();
