...
SOFTWARE.
*/
package com.apress.prospring7.classic.seven.config;
...
@ComponentScan(basePackages = {"com.apress.prospring7.classic.seven.service"})
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.apress.prospring7.classic.seven.entities");
