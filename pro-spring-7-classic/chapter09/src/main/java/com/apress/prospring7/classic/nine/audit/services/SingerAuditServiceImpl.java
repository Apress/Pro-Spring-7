...
SOFTWARE.
*/
package com.apress.prospring7.classic.nine.audit.services;

import com.apress.prospring7.classic.nine.entities.SingerAudit;
import com.apress.prospring7.classic.nine.audit.repos.SingerAuditRepository;
...
public class SingerAuditServiceImpl implements SingerAuditService {
   ...
   // EntityManager entityManager;
    ...
    public SingerAudit findAuditByRevision(Long id, int revision) {
        ...
        // for envers auditing using Custom Data repositories
        return singerAuditRepository.findAuditByIdAndRevision(id, revision).orElse(null);
    }

    @Override
    public List<Revision<Long,SingerAudit>> findAllRevisions(Long id) {
        return singerAuditRepository.findRevisions(id).stream().toList();
    }
}
