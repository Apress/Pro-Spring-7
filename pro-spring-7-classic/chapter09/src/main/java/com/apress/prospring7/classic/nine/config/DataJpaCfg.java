...
@ComponentScan(basePackages = {"com.apress.prospring7.classic.nine.services"})
@EnableJpaRepositories("com.apress.prospring7.classic.nine.repos")
public class DataJpaCfg {
    final DataSource dataSource;

    public DataJpaCfg(DataSource dataSource) {
