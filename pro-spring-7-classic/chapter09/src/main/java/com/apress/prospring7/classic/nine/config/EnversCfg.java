...
@ComponentScan(basePackages = {"com.apress.prospring7.classic.nine.audit"})
@EnableEnversRepositories("com.apress.prospring7.classic.nine.audit.repos")
public class EnversCfg {

 private final DataSource dataSource;

 public EnversCfg(DataSource dataSource) {
 ...
 public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
  ...
  factory.setPackagesToScan("com.apress.prospring7.classic.nine.entities");
