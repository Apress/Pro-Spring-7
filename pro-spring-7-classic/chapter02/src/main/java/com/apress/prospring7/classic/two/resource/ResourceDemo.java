...
SOFTWARE.
*/
package com.apress.prospring7.classic.two.resource;
...
@Configuration
@ComponentScan(basePackages = "com.apress.prospring7.classic.two.resource")
...
class StandardOutMessageRenderer implements MessageRenderer {
    ...
    public void setMessageProvider(MessageProvider provider) {
        out.println(" ~~ Injecting dependency using setter & @Resource ~~");
