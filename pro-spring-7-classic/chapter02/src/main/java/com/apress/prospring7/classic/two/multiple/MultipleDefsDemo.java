...
SOFTWARE.
*/
package com.apress.prospring7.classic.two.multiple;
...
public class MultipleDefsDemo {
    ...
    public static void main(String... args) {
        var ctx = new AnnotationConfigApplicationContext(MultipleDefsDemoConfig.class);
        Mixer mixer = ctx.getBean(Mixer.class);
        logger.info("Mixer: {}", mixer);
    }
}

@Configuration
@ComponentScan
class MultipleDefsDemoConfig {}

interface Mixer {
}

@Component
class Blender implements  Mixer{}

@Component
class StandupMixer implements  Mixer{
