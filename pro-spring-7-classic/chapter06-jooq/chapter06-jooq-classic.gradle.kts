...
description = "Pro Spring 7: Chapter 6 - jOOQ and Spring Integration"
...
dependencies {
    ...
    implementation(libs.jooqCodeGen) // needed for the GenerateJOOQSources class
    ...
    configurations {
        configuration {
            ...
            generator {
                ...
                target {
                    packageName = "com.apress.prospring7.classic.six.jooq.generated"
