...
SOFTWARE.
*/
package com.apress.prospring7.classic.six.base;
...
public class HibernateDemoV1 {
    ...
    static void main() {
         try(final var ctx = new AnnotationConfigApplicationContext(HibernateConfig.class)) {
             final var singerDao = ctx.getBean(SingerDao.class);
