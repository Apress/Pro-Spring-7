...
SOFTWARE.
*/
package com.apress.prospring7.classic.six.base.dao;
...
public class SingerDaoImpl implements  SingerDao {
    ...
    public Singer findAllDetails(String firstName, String lastName) {
        ...
        for (var item : results) {
            ...
            album.setReleaseDate((LocalDate) item.get("RELEASE_DATE"));
    ...
    @Override
    public String findFirstNameByIdUsingProc(Long id) {
        final var query = sessionFactory.getCurrentSession()
                .createStoredProcedureQuery("getFirstNameByIdProc")
        .registerStoredProcedureParameter( "in_id", Long.class, ParameterMode.IN )
        .registerStoredProcedureParameter( "fn_res", String.class, ParameterMode.OUT )
        .setParameter( "in_id", 1L );
        query.execute();
