...
SOFTWARE.
*/
package com.apress.prospring7.classic.six.h2;
...
public class HibernateTestConfig {
    ...
    public Properties hibernateProperties() {
        ...
        hibernateProp.put(Environment.HBM2DDL_AUTO, Action.ACTION_CREATE_THEN_DROP);
        //hibernateProp.put(Environment.HBM2DDL_AUTO, "create-drop");  // equivalent with the above
    ...
    public SessionFactory sessionFactory() {
        return new LocalSessionFactoryBuilder(dataSource())
                .scanPackages("com.apress.prospring7.classic.six.base.entities")
