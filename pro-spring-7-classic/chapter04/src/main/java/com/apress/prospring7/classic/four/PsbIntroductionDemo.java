...
import com.apress.prospring7.classic.four.manual.introduction.Contact;
import com.apress.prospring7.classic.four.manual.introduction.IsModified;
import com.apress.prospring7.classic.four.manual.introduction.IsModifiedAdvisor;
...
public class PsbIntroductionDemo {
 ...
 public static void main(String... args) {
  final var ctx = new AnnotationConfigApplicationContext(IntroductionAopConfig.class);

  Contact proxy = (Contact) ctx.getBean("proxy");
  final var proxyInterface = (IsModified) proxy;
