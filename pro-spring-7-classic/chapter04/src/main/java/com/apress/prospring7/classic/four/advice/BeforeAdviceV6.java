...
public class BeforeAdviceV6 {
 private static final Logger LOGGER = LoggerFactory.getLogger(BeforeAdviceV6.class);

 public BeforeAdviceV6() {
  LOGGER.info("BeforeAdviceV6 creation time: {}" , Instant.now());
 }

 @Pointcut("target(com.apress.prospring7.classic.four.common.Singer+))")
 public void targetIdentifier() {
 }

 @Pointcut("execution(* com.apress.prospring7.classic.four..sing*(com.apress.prospring7.classic.four.common.Guitar))")
