...
public class AfterReturningAdviceV1 {
    private static final Logger LOGGER = LoggerFactory.getLogger(AfterReturningAdviceV1.class);

    @Pointcut("execution(* com.apress.prospring7.classic.four..PretentiousGuitarist.sing*(com.apress.prospring7.classic.four.common.Guitar))  && args(value)")
