...
import com.apress.prospring7.classic.nine.config.MongoCfg;
import com.apress.prospring7.classic.nine.document.Singer;
import com.apress.prospring7.classic.nine.service.SingerService;
...
public class MongoTest {
    ...
    static MongoReplicaSet replicaSet = new MongoReplicaSet();

    @DynamicPropertySource
    static void setProperties(DynamicPropertyRegistry registry) {
        replicaSet.start();
        registry.add("mongo.url", replicaSet::getConnectionString);
